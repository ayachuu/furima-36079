...
ActiveRecord::Schema.define(version: 2021_07_23_232854) do
  ...
  create_table "retailers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_retailers_on_purchase_record_id"
  end
  ...
  add_foreign_key "retailers", "purchase_records"
end
